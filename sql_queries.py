...
(user_id int, first_name varchar, last_name varchar, gender varchar, level varchar, PRIMARY KEY(user_id,level))
""")
...
(art_time timestamp PRIMARY KEY, hour int, day int, week int, month int, year int, weekday int)""")
...
time_table_insert = ("""INSERT INTO time(art_time, hour, day, week, month, year, weekday) VALUES(%s,%s,%s,%s,%s,%s,%s)
